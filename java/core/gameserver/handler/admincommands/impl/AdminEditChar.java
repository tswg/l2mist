...
public class AdminEditChar implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(Enum comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		else if(fullString.equals("admin_captcha"))
			sendCaptchaRequest(activeChar);
		...
		else if(fullString.startsWith("admin_setsubclass"))
		{
			...
			if(st.countTokens() > 1)
			{
				...
				{
					activeChar.sendMessage(new CustomMessage("core.gameserver.model.instances.L2VillageMasterInstance.SubclassCouldNotBeAdded", activeChar));
					return false;
				}
	...
	public static void showCharacterList(Player activeChar, Player player)
	{
		...
		replyMSG.append("</table><br>");
	    replyMSG.append("<center><button value=\"Captcha Request\" action=\"bypass -h admin_captcha\" width=80 height=15 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></center><br>");
	...
	private void sendCaptchaRequest(Player activeChar)
	{
		GameObject target = activeChar.getTarget();
		if(target == null)
		{
		...
		activeChar.sendMessage("Successfully send Captcha Request");
	}
	...
	private void setSubclass(final Player activeChar, final Player player)
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("core.gameserver.model.instances.L2VillageMasterInstance.NoSubAtThisTime", activeChar));
			return;
		}
