...
import core.gameserver.network.l2.s2c.ExMultiPartyCommandChannelInfo;
	...
	public boolean useUserCommand(int id, Player activeChar)
	{
		...
		switch(id)
		{
			...
			case 93: //channeldelete
				...
				{
					core.gameserver.model.CommandChannel channel = activeChar.getParty().getCommandChannel();
