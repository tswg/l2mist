...
public class WhoAmI implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player player, String args)
	{
		...
		double xpRate = Config.RATE_XP * player.getBonus().getRateXp();
		double spRate = Config.RATE_SP * player.getBonus().getRateSp();
		double dropRate = Config.RATE_DROP_ITEMS * player.getBonus().getDropItems();
		double adenaRate = Config.RATE_DROP_ADENA * player.getBonus().getDropAdena();
		double spoilRate = Config.RATE_DROP_SPOIL * player.getBonus().getDropSpoil();
