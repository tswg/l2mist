...
import core.gameserver.network.l2.s2c.ExAirShipTeleportList;
import core.gameserver.network.l2.s2c.ExAskCoupleAction;
import core.gameserver.network.l2.s2c.PrivateStoreManageListBuy;
import core.gameserver.network.l2.s2c.PrivateStoreManageListSell;
import core.gameserver.network.l2.s2c.RecipeShopManageList;
...
public class RequestActionUse extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		//activeChar.sendMessage("Use " + action.type); //send?
		//activeChar.sendMessage("Use " + action.value); //send?
		// Социальные действия
		if(action.type == 3)
		{
