...
import core.gameserver.network.l2.s2c.AskJoinAlliance;
...
public class RequestJoinAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("core.gameserver.clientpackets.RequestJoinAlly.InvitePenalty", activeChar));
			return;
		}
