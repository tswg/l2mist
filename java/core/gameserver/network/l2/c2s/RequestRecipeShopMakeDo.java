...
import core.gameserver.network.l2.s2c.RecipeShopItemInfo;
...
public class RequestRecipeShopMakeDo extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			manufacturer.sendMessage(new CustomMessage("core.gameserver.RecipeController.NoRecipe", manufacturer).addString(recipeList.getRecipeName()));
			buyer.sendMessage(new CustomMessage("core.gameserver.RecipeController.NoRecipe", manufacturer).addString(recipeList.getRecipeName()));
			return;
		}
		...
		manufacturer.sendMessage(new CustomMessage("core.gameserver.RecipeController.GotOrder", manufacturer).addString(recipeList.getRecipeName()));
