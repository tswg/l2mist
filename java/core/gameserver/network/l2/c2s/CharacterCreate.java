...
import core.gameserver.network.l2.s2c.CharacterCreateFail;
import core.gameserver.network.l2.s2c.CharacterCreateSuccess;
...
public class CharacterCreate extends L2GameClientPacket
{
	...
	private void initNewChar(GameClient client, Player newChar)
	{
		...
		if(Config.RVRMODE_ENABLE)
		{
			...
			newChar.setNameColor(Integer.decode(raceColor));
		}
