...
public enum SystemMsg implements IStaticPacket
{
	...
	// Message: Use of your account has been limited due to alleged account. If you have nothing to do with account theft, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	USE_OF_YOUR_ACCOUNT_HAS_BEEN_LIMITED_DUE_TO_ALLEGED_ACCOUNT_THEFT(428),
	// Message: In accordance with company policy, your account has been suspended for submitting a false report. Submitting a false report to the Support Center may harm other players. For more information on account suspension, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	...
	// Message: Your account has been suspended, under Chapter 3, Section 14 of the Lineage II Service Use Agreement, for unethical behavior or fraud. For more information, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	...
	// Message: Your account has been suspended for unethical behavior. For more information, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_UNETHICAL_BEHAVIOR(435),
	// Message: Your account has been suspended for abusing the game system or exploiting bug(s). Abusing bug(s) may cause critical situations as well as harm the game world's balance. For more information, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_ABUSING_THE_GAME_SYSTEM_OR_EXPLOITING_BUGS(436),
	// Message: Your account has been suspended for using illegal software which has not been authorized by our company. For more information, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_USING_ILLEGAL_SOFTWARE_WHICH_HAS_NOT_BEEN_AUTHORIZED_BY_OUR_COMPANY(437),
	// Message: Your account has been suspended for impersonating an official Game Master or staff member. For more information, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_IMPERSONATING_AN_OFFICIAL_GAME_MASTER_OR_STAFF_MEMBER(438),
	// Message: In accordance with the company's User Agreement and Operational Policy this account has been suspended at the account holder's request. If you have any questions regarding your account please contact support at http://us.ncsoft.com/support.
	...
	// Message: Because you are registered as a minor, your account has been suspended at the request of your parents or guardian. For more information, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	BECAUSE_YOU_ARE_REGISTERED_AS_A_MINOR_YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_AT_THE_REQUEST_OF_YOUR_PARENTS_OR_GUARDIAN(440),
	// Message: Per our company's User Agreement, the use of this account has been suspended. If you have any questions regarding your account please contact support at http://us.ncsoft.com/support.
	PER_OUR_COMPANYS_USER_AGREEMENT_THE_USE_OF_THIS_ACCOUNT_HAS_BEEN_SUSPENDED(441),
	// Message: Your account has been suspended, under Chapter 2, Section 7 of the Lineage II Service Use Agreement, for misappropriating payment under another player's account. For more information, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	...
	// Message: Ownership of this account needs to be verified. For more information, Please submit a ticket at the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	...
	// Message: For more information, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
	...
	// Message: For more details, please contact our customer service center at http://us.ncsoft.com/support.
	...
	// Message: If you need help, please visit the Support Center on the PlayNC website (http://us.ncsoft.com/support/).
	...
	*/
	...
	// Message: Your account may have been involved in identity. As such, it has been temporarily restricted. If this does not apply to you, you may obtain normal service by going through self-identification on the homepage. Please refer to the plaync homepage (www.plaync.co.kr) customer center (Lineage 2) clause 1:1 for more details.
	...
	// Message: Your account has been temporarily suspended for playing the game in abnormal ways. If you did not use abnormal means, please visit the Support Center on the NCsoft website (http://us.ncsoft.com/support).
