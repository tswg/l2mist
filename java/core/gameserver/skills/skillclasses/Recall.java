...
public class Recall extends Skill
{
	...
	public boolean checkCondition(Creature activeChar, Creature target, boolean forceUse, boolean dontMove, boolean first)
	{
		...
		{
			if(activeChar.isPlayer())
				activeChar.sendMessage(new CustomMessage("core.gameserver.skills.skillclasses.Recall.Here", (Player) activeChar));
			return false;
		}
	...
	public void useSkill(final Creature activeChar, List<Creature> targets)
	{
		for(final Creature target : targets)
			if(target != null)
			{
				...
				{
					activeChar.sendMessage(new CustomMessage("core.gameserver.skills.skillclasses.Recall.Festival", (Player) activeChar));
					continue;
				}
