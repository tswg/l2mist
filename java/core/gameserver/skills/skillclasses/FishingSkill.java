...
public class FishingSkill extends Skill
{
	...
	public void useSkill(Creature caster, List<Creature> targets)
	{
		...
		int group = core.gameserver.model.Fishing.getFishGroup(lure.getItemId());
		int type = core.gameserver.model.Fishing.getRandomFishType(lureId);
		int lvl = core.gameserver.model.Fishing.getRandomFishLvl(player);
