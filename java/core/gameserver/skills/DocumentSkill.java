...
public final class DocumentSkill extends DocumentBase
{
	...
	public class Skill
	{
		...
		public List<core.gameserver.model.Skill> skills = new ArrayList<core.gameserver.model.Skill>();
		public List<core.gameserver.model.Skill> currentSkills = new ArrayList<core.gameserver.model.Skill>();
	}

	private Skill currentSkill;
	private Set<String> usedTables = new HashSet<String>();
	private List<core.gameserver.model.Skill> skillsInFile = new LinkedList<core.gameserver.model.Skill>();
	...
	protected List<core.gameserver.model.Skill> getSkills()
	{
		return skillsInFile;
	}
	...
	protected void parseSkill(Node n)
	{
		...
		try
		{
			...
			for(int i = 0; i < lastLvl; i++)
			{
				...
				core.gameserver.model.Skill current = currentSkill.currentSkills.get(i);
	...
	{
		currentSkill.currentSkills = new ArrayList<core.gameserver.model.Skill>(currentSkill.sets.length);
