package core.gameserver.model.quest;
...
import core.commons.logging.LogUtils;
...
import core.gameserver.network.l2.s2c.ExNpcQuestHtmlMessage;
...
public class Quest
{
	...
	/**
	 * Добавляет нпц масив для слушателя при их убийстве, и обновлении пакетом {@link core.gameserver.network.l2.s2c.ExQuestNpcLogList}
	 * @param cond
	 * @param varName
	 * @param killIds
	 */
