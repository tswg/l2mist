package core.gameserver.model.actor.instances.player;
...
import core.gameserver.network.l2.s2c.ExNavitAdventEffect;
import core.gameserver.network.l2.s2c.ExNavitAdventPointInfo;
import core.gameserver.network.l2.s2c.ExNavitAdventTimeChange;
...
public class NevitSystem
{
	...
	private void startNevitEffect(int time)
	{
		...
		if(time > 0)
		{
			...
			if(getAddVitality() == 0)
				setAddVitality(_player.getVitality());
			setAddVitality(getAddVitality() + Config.ALT_VITALITY_NEVIT_POINT);
		}
	}
	...
	public double getAddVitality()
	{
		return _oldVit;
	}

	public void setAddVitality(double set)
	{
		_oldVit = set;
	}
