...
import core.gameserver.model.items.listeners.AccessoryListener;
import core.gameserver.model.items.listeners.ArmorSetListener;
import core.gameserver.model.items.listeners.BowListener;
import core.gameserver.model.items.listeners.ItemAugmentationListener;
import core.gameserver.model.items.listeners.ItemEnchantOptionsListener;
import core.gameserver.model.items.listeners.ItemSkillsListener;
...
import core.gameserver.taskmanager.DelayedItemsManager;
...
public class PcInventory extends Inventory
{
	...
	public int getPaperdollItemId(int slot)
	{
		...
		if(player.getVar("FormalWearId") != null && player.getVar("HideCostume") == null && !player.isInOlympiadMode())
		{
			if(slot == PAPERDOLL_CHEST)
				itemId = player.getVarInt("FormalWearId");
			if(slot == PAPERDOLL_LEGS || slot ==  PAPERDOLL_GLOVES || slot ==  PAPERDOLL_FEET)
				return 0;
		}
