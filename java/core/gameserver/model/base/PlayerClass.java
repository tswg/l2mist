package core.gameserver.model.base;

import static core.gameserver.model.base.ClassLevel.First;
import static core.gameserver.model.base.ClassLevel.Fourth;
import static core.gameserver.model.base.ClassLevel.Second;
import static core.gameserver.model.base.ClassLevel.Third;
import static core.gameserver.model.base.ClassType.Fighter;
import static core.gameserver.model.base.ClassType.Mystic;
import static core.gameserver.model.base.ClassType.Priest;
import static core.gameserver.model.base.Race.darkelf;
import static core.gameserver.model.base.Race.dwarf;
import static core.gameserver.model.base.Race.elf;
import static core.gameserver.model.base.Race.human;
import static core.gameserver.model.base.Race.kamael;
import static core.gameserver.model.base.Race.orc;
...
public enum PlayerClass
{
	...
	public static EnumSet<PlayerClass> getRaceSet(Race race)
	{
		EnumSet<PlayerClass> allOf = EnumSet.noneOf(PlayerClass.class);

		for(PlayerClass playerClass : EnumSet.allOf(PlayerClass.class))
			if(playerClass.isOfRace(race))
				allOf.add(playerClass);
