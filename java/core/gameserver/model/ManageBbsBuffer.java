...
public class ManageBbsBuffer
{
	...
	{
		this.listScheme = new LinkedList<SBufferScheme>();
	}
	...
	{
		List<Integer> skills_id = new LinkedList<Integer>();
	...
	{
		List<SBufferScheme> list = new LinkedList<SBufferScheme>();
	...
	public static class SBufferScheme
	{
		...
		public SBufferScheme()
		{
			...
			this.obj_id = 0;
			this.name = "";
			this.skills_id = new LinkedList<Integer>();
		}
	}
}