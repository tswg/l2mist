...
import core.gameserver.model.base.BaseStats;
...
import core.gameserver.network.l2.s2c.FlyToLocation.FlyType;
import core.gameserver.network.l2.s2c.SystemMessage2;
import core.gameserver.skills.effects.EffectTemplate;
import core.gameserver.skills.skillclasses.AIeffects;
import core.gameserver.skills.skillclasses.Aggression;
import core.gameserver.skills.skillclasses.Balance;
import core.gameserver.skills.skillclasses.BeastFeed;
import core.gameserver.skills.skillclasses.BuffCharger;
import core.gameserver.skills.skillclasses.CPDam;
import core.gameserver.skills.skillclasses.Call;
import core.gameserver.skills.skillclasses.ChainHeal;
import core.gameserver.skills.skillclasses.Charge;
import core.gameserver.skills.skillclasses.ChargeSoul;
import core.gameserver.skills.skillclasses.ClanGate;
import core.gameserver.skills.skillclasses.CombatPointHeal;
import core.gameserver.skills.skillclasses.Continuous;
import core.gameserver.skills.skillclasses.Craft;
import core.gameserver.skills.skillclasses.CurseDivinity;
import core.gameserver.skills.skillclasses.DeathPenalty;
import core.gameserver.skills.skillclasses.Decoy;
import core.gameserver.skills.skillclasses.Default;
import core.gameserver.skills.skillclasses.DefuseTrap;
import core.gameserver.skills.skillclasses.DeleteHate;
import core.gameserver.skills.skillclasses.DeleteHateOfMe;
import core.gameserver.skills.skillclasses.DestroySummon;
import core.gameserver.skills.skillclasses.DetectTrap;
import core.gameserver.skills.skillclasses.Disablers;
import core.gameserver.skills.skillclasses.DisablersRoot;
import core.gameserver.skills.skillclasses.Drain;
import core.gameserver.skills.skillclasses.DrainSoul;
import core.gameserver.skills.skillclasses.EffectsFromSkills;
import core.gameserver.skills.skillclasses.EnergyReplenish;
import core.gameserver.skills.skillclasses.ExtractStone;
import core.gameserver.skills.skillclasses.FishingSkill;
import core.gameserver.skills.skillclasses.Harvesting;
import core.gameserver.skills.skillclasses.Heal;
import core.gameserver.skills.skillclasses.HealPercent;
import core.gameserver.skills.skillclasses.SummonHealPercent;
import core.gameserver.skills.skillclasses.InstantJump;
import core.gameserver.skills.skillclasses.KamaelWeaponExchange;
import core.gameserver.skills.skillclasses.LearnSkill;
import core.gameserver.skills.skillclasses.LethalShot;
import core.gameserver.skills.skillclasses.MDam;
import core.gameserver.skills.skillclasses.ManaDam;
import core.gameserver.skills.skillclasses.ManaHeal;
import core.gameserver.skills.skillclasses.ManaHealPercent;
import core.gameserver.skills.skillclasses.SummonManaHealPercent;
import core.gameserver.skills.skillclasses.NegateEffects;
import core.gameserver.skills.skillclasses.NegateStats;
import core.gameserver.skills.skillclasses.PDam;
import core.gameserver.skills.skillclasses.PcBangPointsAdd;
import core.gameserver.skills.skillclasses.PcBangPointsAddrnd;
import core.gameserver.skills.skillclasses.PetSummon;
import core.gameserver.skills.skillclasses.Recall;
import core.gameserver.skills.skillclasses.ReelingPumping;
import core.gameserver.skills.skillclasses.Refill;
import core.gameserver.skills.skillclasses.Resurrect;
import core.gameserver.skills.skillclasses.Ride;
import core.gameserver.skills.skillclasses.SPHeal;
import core.gameserver.skills.skillclasses.ShiftAggression;
import core.gameserver.skills.skillclasses.Sowing;
import core.gameserver.skills.skillclasses.Spoil;
import core.gameserver.skills.skillclasses.StealBuff;
import core.gameserver.skills.skillclasses.SummonItem;
import core.gameserver.skills.skillclasses.SummonSiegeFlag;
import core.gameserver.skills.skillclasses.Sweep;
import core.gameserver.skills.skillclasses.TakeCastle;
import core.gameserver.skills.skillclasses.TakeFlag;
import core.gameserver.skills.skillclasses.TakeFortress;
import core.gameserver.skills.skillclasses.TameControl;
import core.gameserver.skills.skillclasses.TeleportNpc;
import core.gameserver.skills.skillclasses.Toggle;
import core.gameserver.skills.skillclasses.Transformation;
import core.gameserver.skills.skillclasses.Unlock;
import core.gameserver.skills.skillclasses.VitalityHeal;
import core.gameserver.stats.Env;
import core.gameserver.stats.Formulas;
import core.gameserver.stats.StatTemplate;
import core.gameserver.stats.Stats;
import core.gameserver.stats.conditions.Condition;
...
public abstract class Skill extends StatTemplate implements Cloneable
{
	...
	public static enum SkillType
	{
		...
		EFFECT(core.gameserver.skills.skillclasses.Effect.class),
		...
		HARDCODED(core.gameserver.skills.skillclasses.Effect.class),
		...
		SUMMON(core.gameserver.skills.skillclasses.Summon.class),
		...
		if(player != null)
		{
			...
			if(pcTarget != null)
			{
				...
				if(isOffensive())
				{
					...
					//	return SystemMsg.THAT_IS_AN_INCORRECT_TARGET;
					if((isAoE() || isPvpSkill()) && getCastRange() < Integer.MAX_VALUE && !GeoEngine.canSeeTarget(activeChar, target, activeChar.isFlying()))
						return SystemMsg.CANNOT_SEE_TARGET;
					...
					if(isPvpSkill() || !forceUse || isAoE())
					{
						...
						if(activeChar.isPlayer() && target.getPlayer().getGameEvent() != null && activeChar.getPlayer().getGameEvent() != null 
							...
							return SystemMsg.INVALID_TARGET;
						if(target.isFakeDeath() || target.isDead())
							return SystemMsg.INVALID_TARGET;
					...
					if(forceUse && !isPvpSkill() && (!isAoE() || aimingTarget == target))
						return null;
					if(Config.RVRMODE_ENABLE && !player.isInOlympiadMode() && player.getTeam() == TeamType.NONE && !player.isInZone(ZoneType.SIEGE) && !pcTarget.isInZone(ZoneType.SIEGE) && player.getRace() != pcTarget.getRace())
						return null;
					return SystemMsg.INVALID_TARGET;
				}
				...
				if(pcTarget == player)
					return null;
				//if(pcTarget.isInOlympiadMode() && player.isInOlympiadMode() && player.isOlympiadCompStart())
				//	return null;
				if(player.isInOlympiadMode() && !forceUse && player.getOlympiadSide() != pcTarget.getOlympiadSide()) // Чужой команде помогать нельзя
					return SystemMsg.THAT_IS_AN_INCORRECT_TARGET;
				// RvR Mode запрещаем хилить и бафать враждебную расу
				if(Config.RVRMODE_ENABLE && !player.isInOlympiadMode() && player.getTeam() == TeamType.NONE && !player.isInZone(ZoneType.SIEGE) && !pcTarget.isInZone(ZoneType.SIEGE) && player.getRace() != pcTarget.getRace())
					if(_skillType == SkillType.BUFF || _skillType == SkillType.HEAL || _skillType == SkillType.HEAL_PERCENT || _skillType == SkillType.MANAHEAL  || _skillType == SkillType.RESURRECT)
						return SystemMsg.INVALID_TARGET;
				//TODO [VISTALL] что за?
	...
	public void setIsUseMacro(boolean isUse)
	{
		_isUseMacro = isUse;
	}
}