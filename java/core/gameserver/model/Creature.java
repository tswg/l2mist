...
import core.gameserver.geodata.GeoMove;
import core.gameserver.instancemanager.DimensionalRiftManager;
import core.gameserver.instancemanager.ReflectionManager;
import core.gameserver.model.GameObjectTasks.AltMagicUseTask;
import core.gameserver.model.GameObjectTasks.CastEndTimeTask;
import core.gameserver.model.GameObjectTasks.halfCastTimeLaunchedTask;
import core.gameserver.model.GameObjectTasks.HitTask;
import core.gameserver.model.GameObjectTasks.MagicLaunchedTask;
import core.gameserver.model.GameObjectTasks.MagicUseTask;
import core.gameserver.model.GameObjectTasks.NotifyAITask;
...
import core.gameserver.model.actor.listener.CharListenerList;
import core.gameserver.model.actor.recorder.CharStatsChangeRecorder;
...
import core.gameserver.model.instances.MinionInstance;
...
import core.gameserver.network.l2.s2c.Attack;
import core.gameserver.network.l2.s2c.AutoAttackStart;
import core.gameserver.network.l2.s2c.AutoAttackStop;
import core.gameserver.network.l2.s2c.ChangeMoveType;
import core.gameserver.network.l2.s2c.CharMoveToLocation;
import core.gameserver.network.l2.s2c.FlyToLocation;
import core.gameserver.network.l2.s2c.L2GameServerPacket;
import core.gameserver.network.l2.s2c.MagicSkillCanceled;
...
import core.gameserver.taskmanager.RegenTaskManager;
...
public abstract class Creature extends GameObject
{
	...
	public Future<?> _halfCastTimeLaunchedTask;
	...
	public final void abortCast(boolean force, boolean message)
	{
		if(isCastingNow() && (force || canAbortCast()))
		{
			...
			final Future<?> skillCastTimeLaunchedTask = _halfCastTimeLaunchedTask;
			...
			if(skillCastTimeLaunchedTask != null)
				skillCastTimeLaunchedTask.cancel(false);
		...
		for(int field : fields)
			switch(field)
			{
				...
				case StatusUpdate.PVP_FLAG:
					su.addAttribute(field, Config.RVRMODE_ENABLE ? 0 : getPvpFlag());
					break;
			}
		return su;
	}
	...
	public void doCast(Skill skill, Creature target, boolean forceUse)
	{
		...
		int skillHalfCastTime = (int) (0.50 * skillTime);
		...
		if(Config.ALT_DAMAGE_INVIS == 3 && skillHalfCastTime > 500)
			_halfCastTimeLaunchedTask = ThreadPoolManager.getInstance().schedule(new halfCastTimeLaunchedTask(this, forceUse), skillHalfCastTime);
	...
	{
		return getEffectList().getEffectByType(EffectType.Mute) != null;
	}

	public boolean isPhysicalMuted()
	{
		return getEffectList().getEffectByType(EffectType.MutePhisycal) != null;
	}

	public boolean isImmobileUntilAttacked()
	{
		return getEffectList().getEffectByType(EffectType.MuteAttack) != null;
	}
	/**
	...
	public int getAbnormalEffect()
	{
		...
		if(isPhysicalMuted())
			ae |= AbnormalEffect.MUTED.getMask();
		if(isParalyzed())
			ae |= AbnormalEffect.HOLD_2.getMask();
...
/*
	...
	public void clearCastVars()
	{
		...
		_halfCastTimeLaunchedTask = null;
		_flyLoc = null;
	}
	...
	public void reduceCurrentHp(double damage, Creature attacker, Skill skill, boolean awake, boolean standUp, boolean directHp, boolean canReflect, boolean transferDamage, boolean isDot, boolean sendMessage)
	{
		...
		if(Config.ALT_DAMAGE_INVIS == 2 && Config.ALT_DAMAGE_INVIS_PART == 3)
		{
			if(!GeoEngine.canSeeTarget(this, attacker, false))
				damage = 0.;
		}
		if(Config.ALT_DAMAGE_INVIS == 3 && Config.ALT_DAMAGE_INVIS_PART == 3)
		{	
			if(!GeoEngine.canSeeTarget(this, attacker, false))
			{
				damage = damage*0.50;
