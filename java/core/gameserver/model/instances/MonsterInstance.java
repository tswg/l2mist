...
import core.gameserver.model.AggroList.HateInfo;
...
{
	private static final long serialVersionUID = 1311616678428768365L;
	...
	protected void onDeath(Creature killer)
	{
		...
		if(Config.CAPTCHA_ENABLE)
		{
			if(killer != null && killer.isPlayable())
			{
				...
				if(Rnd.get(0, 100) < 2 && player.getCaptchaReguest() < System.currentTimeMillis())
				{
					CaptchaValidator.getInstance().sendCaptcha(player);
					player.setCaptchaReguest();
				}
			}
		}
	...
	public void calculateRewards(Creature lastAttacker)
	{
		...
		for(Player attacker : attackers)
		{
			...
			dropCalc(lastAttacker, topDamager);
	...
	private void dropCalc(Creature lastAttacker, Creature topDamager)
	{
