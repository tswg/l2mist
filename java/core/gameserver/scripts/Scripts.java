...
import core.commons.compiler.Compiler;
import core.commons.compiler.MemoryClassLoader;
import core.gameserver.Config;
import core.gameserver.model.Player;
import core.gameserver.model.quest.Quest;
import core.gameserver.scripts.jarloader.JarClassLoader;
...
public class Scripts
{
	...
	private void load()
	{
		...
		File f = new File("../serverslibs/core-scripts.jar");
		if(f.exists())
		{
			JarClassLoader jcl;
			try
			{
				jcl = new JarClassLoader("../serverslibs/core-scripts.jar");
			...
			{
				_log.error("Fail to load core-scripts.jar!", e);
				classes.clear();
			}
			finally
			{
