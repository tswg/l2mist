package core.gameserver.templates.npc;
...
import core.commons.util.TroveUtils;
...
import core.gameserver.model.instances.RaidBossInstance;
...
import core.gameserver.model.reward.RewardList;
import core.gameserver.model.reward.RewardType;
...
public final class NpcTemplate extends CharTemplate
{
	...
	private void setType(String type)
	{
		...
		try
		{
			classType = (Class<NpcInstance>) Class.forName("core.gameserver.model.instances." + type + "Instance");
		}
	...
	private void setAI(String ai)
	{
		...
		try
		{
			classAI = (Class<CharacterAI>) Class.forName("core.gameserver.ai." + ai);
		}
		catch(ClassNotFoundException e)
		{
